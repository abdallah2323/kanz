...
@section('title', 'Index Paid Courses')
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="sub-title" style="font-size: 18px;font-weight: 700">Paid Courses Table</h5>
                            <span style="text-transform: capitalize">Here you'll show paid courses informations</span>
