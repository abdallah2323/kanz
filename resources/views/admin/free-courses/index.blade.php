...
@section('title', 'Index Free Courses')
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="sub-title" style="font-size: 18px;font-weight: 700">Free Courses Table</h5>
                            <span style="text-transform: capitalize">Here you'll show free courses informations</span>
                                    ...
                                    <tbody>
                                        @foreach ($courses as $key => $course)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $course->name }}</td>
                                                <td>{{ $course->brief }}</td>
                                                <td><span class="badge bg-success" style="font-size: 15px; font-weight:600">{{ $course->type }}</span></td>
                                                <td>
