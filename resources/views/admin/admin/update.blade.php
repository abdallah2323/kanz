...
<div class="main-body">
    <div class="page-wrapper">
        ...
        @section('sub-text')
            ...
            update admin that you selected
        ...
        <div class="page-body">
            <div class="card">
                    <div class="card-block">
                        <h2 class="sub-title" style="font-size: 18px; text-align:center">Update Admin</h2>
                        ...
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" id="email" value="{{ $admin->email }}" name="email" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select id="country" class="form-control" name="country">
                                        <option value="{{ $admin->country }}" disabled selected>{{ $admin->country }}</option>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Address</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $admin->address }}" id="address" name="address" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" value="{{ $admin->photo }}" name="photo" id="photo" class="form-control">
                                </div>
                            </div>
                            <button type="button" onclick="update({{$admin->id}})" class="btn btn-warning">Update</button>
                        </form>
                    </div>
            </div>
        </div>
