                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material">
                            <div class="text-center">
                                <img src="{{ asset('project/assets/images/auth/logo-dark.png') }}" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <img src="{{ asset('project/assets/images/auth/Logo-small-bottom.png') }}" alt="small-logo.png">
                                    </div>
                                </div>
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{ asset('project/assets/js/common-pages.js') }}"></script>
        ...
        function login() {
            axios.post('/cms/admin/login', {
                ...
                .then(function(response) {
                    ...
                    window.location.href = "/cms/admin"; // الانتقال الي الراوت المكتوب عند اضافة عنصر
                })
