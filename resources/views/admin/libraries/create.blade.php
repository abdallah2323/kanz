...
<div class="main-body">
    <div class="page-wrapper">
        ...
        @section('sub-title')
            ...
            Add Attachments to Library

        @endsection

        @section('sub-text')

            add new attachments to the website library
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-block">
                            <h2 class="sub-title" style="font-size: 18px; text-align:center">Add New Attachment</h2>
                            <form>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Attachment Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Enter Attachment Name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Attachment File</label>
                                    <div class="col-sm-10">
...
<script>
    function store() {
        ...
        axios.post('/cms/admin/libraries', formData, {
