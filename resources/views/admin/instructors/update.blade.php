...
<div class="main-body">
    <div class="page-wrapper">
        ...
        @section('sub-title')
            ...
            Update {{ $instructor->name }} Instructor

        @endsection

        @section('sub-text')

            update instructor that you selected
        ...
        <div class="page-body">
            <div class="card">
                    <div class="card-block">
                        <h2 class="sub-title" style="font-size: 18px; text-align:center">Update Instructor</h2>

                        <form enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Name</label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{ $instructor->name }}" id="name" name="name" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Email</label>
                                <div class="col-sm-10">
                                    <input type="email" id="email" value="{{ $instructor->email }}" name="email" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Phone Number</label>
                                <div class="col-sm-10">
                                    <input type="text" id="phone_number" name="phone_number" class="form-control" value="{{ $instructor->phone_number }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="gender" id="gender" class="form-control">
                                        <option selected hidden>{{$instructor->gender}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select id="country" class="form-control" name="country">
                                        <option value="{{ $instructor->country }}" disabled selected>{{ $instructor->country }}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                        <input type="text" value="{{ $instructor->address }}" id="address" name="address" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Upload File</label>
                                <div class="col-sm-10">
                                    <input type="file" value="{{ $instructor->photo }}" name="photo" id="photo" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Specialty</label>
                                <div class="col-sm-10">
                                    <input type="text" id="specialty" name="specialty" class="form-control" value="{{ $instructor->specialty }}">
                                </div>
                            </div>
                            <button type="button" onclick="update({{$instructor->id}})" class="btn btn-warning">Update</button>
                        </form>
                    </div>
            </div>
        </div>
...
<script>
    ...
    const formData = new FormData();
        ...
        formData.append('gender', document.getElementById('gender').checked ? 'male':'female');
    ...
    axios.post('/cms/admin/instructors/'+id, formData)
        .then(function (response) {
        // handle success
        console.log(response);
        toastr.success(response.data.message);
        // document.getElementById('create-form').reset(); //عمل اعادة تحدث للصفحة بعد اضافة عنصر
        window.location.href= "/cms/admin/instructors"; // الانتقال الي الراوت المكتوب عند اضافة عنصر
        })
