...
<div class="main-body">
    <div class="page-wrapper">
        ...
        @section('sub-text')
            ...
            see all users registered in the website
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-block">
                            <h2 class="sub-title" style="font-size: 18px; text-align:center">Add New User</h2>
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" id="email" name="email" class="form-control" placeholder="Enter User E-mail">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="code" id="code" class="form-control">
                                            ...
                                            <option data-countryCode="" value="972">Israel (+970)</option>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" id="phone_number" name="phone_number" class="form-control" placeholder="Enter User Phone Number">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Date of Birth</label>
                                    <div class="col-sm-10">
                                        <input type="date" id="birth" name="birth" class="form-control" placeholder="Enter Date of Birth">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="gender" id="gender" class="form-control">
                                            <option selected hidden value="opt1">Select Gender</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="level_id" id="level_id" class="form-control">
                                            <option selected hidden value="opt1">Select English Level</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="education_id" id="education_id" class="form-control">
                                            <option selected hidden value="opt1">Select Education Level</option>
