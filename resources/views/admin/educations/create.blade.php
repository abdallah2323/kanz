                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-block">
                            <h2 class="sub-title" style="font-size: 18px; text-align:center">Add New Education Level</h2>
                            <form>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Education Level</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="level" name="level" class="form-control" placeholder="Enter Education Level">
                                    </div>
                                </div>
