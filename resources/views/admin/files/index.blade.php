...
<div class="main-body">
    <div class="page-wrapper">
        ...
        @section('link')
            ...
            <li class="breadcrumb-item"><a href="{{ route('files.create') }}">Create New File</a></li>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="sub-title" style="font-size: 18px;font-weight: 700">Files Table</h5>
                                        ...
                                        @foreach ($files as $key => $file)
                                            ...
                                            <tr>
                                                <th scope="row">{{ ++$key }}</th>
                                                    ...
                                                    <td>{{ $file->created_at->isoFormat('LLLL') }}</td>
                                                    <td>
                                                        <div class="btn-group">
                                                        <a href="{{route('files.edit',$file->id)}}" type="button" class="btn btn-info">
                                                            <i class="ti-pencil-alt"></i>
                                                        </a>
                                                        <a href="#" class="btn btn-danger" onclick="confirmDestroy({{$file->id}}, this)">
                                                            <i class="ti-trash"></i>
                                                        </a>
                                                        </div>
                                                    </td>
