    ...
    <div class="col-lg-9 col-md-9">
        <div class="box-1">
            <div class="heading-div">
                <h1 class="heading_1">تعديل الحساب</h1>
                <a href="{{ route('user-profile') }}" class="a--box">مشاهدة الصفحة الشخصية</a>
            </div>
            <form action="">
                <div class="image-div">
                    <img src="{{ asset('project/uploads/users/'. Auth::user()->image) }}" id="image_preview_container" alt="" class="img--div" />
                    <div class="input-group mb-3">
                        <input type="file" value="{{ Auth::user()->image }}" name="photo" id="photo" class="form-control" id="inputGroupFile02" />
                    </div>
                </div>
                <hr class="hr-1" />

                <label for="email">البريد الإلكتروني</label>
                <input type="email" name="email" id="email" value="{{ Auth::user()->email }}" class="inpu-1" />

                <label for="name">الإسم</label>
                <input type="text" name="name" id="name" value="{{ Auth::user()->name }}" class="inpu-1" />

                <label for="phone_number" class="">رقم الهاتف</label>
                <div class="telephone">
                    <input type="tel" name="phone_number" id="phone_number" value="{{ Auth::user()->phone_number }}" class="input-1 hieght"
                        placeholder="ادخل رقم الهاتف">
                    <select name="code" id="code" class="select-1 code">
                        <option selected disabled value="{{ Auth::user()->code }}">{{ Auth::user()->code }}</option>
                ...
                <label for="" class="">البلد</label>
                <select name="country" id="country" class="select-1">
                    <option value="{{ Auth::user()->country }}" disabled selected>{{ Auth::user()->country }}</option>
                ...
                <div class="btn--1">
                    <button type="button" onclick="update({{Auth::user()->id}})" class="btn__1">حفظ التغييرات</button>
                </div>
            </form>
        </div>
    </div>
