        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6  text-sm-end">
                    ...
                    <form>
                        <label for="name" class="label-1">الاسم بالكامل</label><br>
                        <input class="input-1" type="text" name="name" id="name"
                            placeholder="أدخل الاسم بالكامل"><br>

                        <label for="email" class="label-2">البريد الالكتروني</label><br>
                        <input class="input-1" type="email" name="email" id="email"
                            placeholder="أدخل البريد الالكتروني"><br>

                        <label for="phone" class="label-3">رقم الهاتف</label>
                        <div class="telephone">
                            <input type="tel" name="phone_number" id="phone_number" class="input-1 hieght"
                                placeholder="ادخل رقم الهاتف">
                            <select style="height: 50px" name="code" id="code" class="select-1 code">
                                <option selected disabled value="">Select Country Code</option>
                                <option data-countryCode="" value="970">Palestine (+970)</option>
                                <option data-countryCode="" value="972">Israel (+972)</option>
                                <option data-countryCode="" value="962">Jordan (+962)</option>
                        ...
                        <label class="label-2">تاريخ الميلاد</label><br>
                        <input class="input-1" type="date" name="birth" id="birth" />

                        <label class="label-2 mb-2">الجنس</label><br>
                        <select name="gender" id="gender" class="select-1 mb-2">
                            <option value="" selected hidden>حدد الجنس</option>
                            <option value="male">ذكر</option>
                            <option value="female">أنثى</option>
                        </select>

                        <label class="label-2 mb-2">مستواك باللغة الانجليزية</label><br>
                        <select name="level_id" id="level_id" class="select-1">
                            <option value="" selected hidden>حدد مستواك</option>
                            @foreach ($levels as $level)
                                <option value="{{ $level->id }}">{{ $level->level }}</option>
                            @endforeach
                        </select>

                        <label class="label-2 mb-2">المرحلة التعليمية</label><br>
                        <select name="education_id" id="education_id" class="select-1">
                            <option value="" selected hidden>حدد المرحلة</option>
                            @foreach ($educations as $education)
                                <option value="{{ $education->id }}">{{ $education->education }}</option>
                            @endforeach
                        </select>

                        <label class="label-2 mb-2">البلد</label><br>
                        <select name="country" id="country" class="select-1">
                            <option value="" hidden selected>إختر</option>
                        ...
                        <label for="address" class="label-1 mt-2">العنوان</label><br>
                        <input class="input-1" type="text" name="address" id="address"
                            placeholder="ادخل عنوانك"><br>



                        <div class="div-check">
                            <input type="checkbox" name="check" id="check" class="check">
                            <p class="paragraph-2">قرأت و أوافق على <a href="{{ route('privacy-page') }}" class="span-1">شروط
                                    الاستخدام</a> و <a href="{{ route('privacy-page') }}" class="span-1">سياسة
                                    الخصوصية</a></p>
                        </div>
                        <input type="hidden" name="photo"  id="photo" value="logo-black.png">
                        <input class="input-2" value="إنشاء حساب" onclick="store()" type="button">
                        <div class="div-1">
                            <p class="paragraph-3">هل لديك حساب؟</p>
                            <a href="{{ route('user-login') }}" class="sign-up">تسجيل دخول</a>
                        </div>
                    </form>
                </div>
