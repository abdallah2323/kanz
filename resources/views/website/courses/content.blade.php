                    ...
                    <div class="row">
                        <div class="box">
                            @if ($course->lectures->isEmpty())
                                ...
                                <p class="p-7">لم يتم رفع محاضرات بعد</p>
                            @else
                                <!--<video width="100%" height="100%" autoplay muted controls>-->
                                <!--    <source src="{{ asset('project/uploads/lectures')}}/{{ $course->lectures->first()['video'] }}"-->
                                <!--        type="video/mp4" />-->
                                <!--</video> -->
                                <div class="container-1">
                                    <div class="video_player">
                                        <video preload="metadata" class="main-video"
                                            src="{{ asset('project/uploads/lectures')}}/{{ $course->lectures->first()['video'] }}">
                        ...
                        <div class="row">
                            <div class="box-1" style="text-transform: capitalize">
                                <a style="text-decoration: none" href="{{ route('course-content', $course->id) }}">
                                    <h4 class="mt-5 mb-3 h4-1">{{ $course->name }}</h4>
                                </a>
                                @if(count($course->lectures)>0)
                                
                                    <p class="p-7">{{ $course->lectures->first()['title'] }}</p>
                                    ...
                                    <ol class="mt-4 div1 single">
                                        ...
                                        @foreach ($course->lectures as $lecture)
                                            <li>
                                                <a href="{{ route('lecture-show', $lecture->id) }}" class="a-1">
                                                    {{ $lecture->title }} </a>
                                            </li>
                                        @endforeach
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="23.905" height="21.105" viewBox="0 0 23.905 21.105">
                        <defs>
                            ...
                            <symbol id="heart-fill" viewBox="0 0 23.905 21.105">
                                <path
                                    d="M22.539,6.186a5.764,5.764,0,0,0-8.153,0L13.275,7.3,12.164,6.186a5.765,5.765,0,1,0-8.153,8.153L5.122,15.45,13.275,23.6l8.153-8.153,1.111-1.111a5.764,5.764,0,0,0,0-8.153Z"
                                    fill="red" stroke="red" transform="translate(-1.323 -3.497)" fill="none"
                                    stroke="red" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" />
                            </symbol>
                        </defs>
                    </svg>
                    <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        @foreach ($course->posts as $post)
                            <div class="box mb-3">
                                <div class="image">
                                    <img src="{{ asset('project/uploads/instructors/' . $post->course->instructor->photo) }}"
                                        alt="" class="Ahmed" />
                                    <div class="content">
                                    ...
                                    <div class="video_player">
                                        <video preload="metadata" class="main-video"
                                            ...
                                            <track label="English" kind="subtitles"
                                                src="./How To Get Started With VSCode.vtt" srclang="en">
                                            <track label="Urdu" kind="subtitles" src="./test.vtt" srclang="en">
                                        </video>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="box-1" style="text-transform: capitalize">
                                ...
                                @if(count($course->lectures)>0)
                                    ...
                                    <a href="{{ route('student-register', $course->id) }}" class="form-control a-2">اشترك في هذه
                                        الدورة</a>
                                    ...
                                    <ol class="mt-4 div1 single">
                                        ...
                                        @foreach ($course->lectures as $lecture)
                                            <li>
                                                <a href="{{ route('student-register', $course->id) }}" class="a-1">
                                                    {{ $lecture->title }} </a>
                                            </li>
                                        @endforeach
                                @endif
    ...
    @else
                    ...
                    <div class="row">
                        <div class="box-1" style="text-transform: capitalize">
                            ...
                            @if(count($course->lectures)>0)
                                ...
                                <a href="{{ route('user-login') }}" class="form-control a-2">اشترك في هذه الدورة</a>
        ...
        <section class="section-2 mt-5 div2 single" style="display: none">
            <div class="container">
                <div class="row">
                    @if ($course->price)
                        {{-- اذا كان الكورس مدفوع يجب التسجيل --}}
                        @foreach ($course->files as $file)
                            <label for="pdf" class="mb-4">
                                <a href="{{ route('student-register', $course->id) }}" class="a-1">
                                    @if($file->type == 'pdf')<img src="{{ asset('project/website/img/pdf.png') }}" alt="" class="pdf" />@else<img src="{{ asset('project/website/img/word.png') }}" alt="" class="pdf" />@endif
                        ...
                        @endforeach
                    @else
                        {{-- اذا كان الكورس مجاني (حمل الملف) --}}
